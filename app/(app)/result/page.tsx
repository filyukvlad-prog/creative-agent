...
export default function ResultPage() {
  ...
  useEffect(() => {
    ...
    const t = sessionStorage.getItem("ca_last_result") || "";
    const pStr = sessionStorage.getItem("ca_last_payload") || "{}";
  ...
  return (
    <div style={{ display: "grid", gap: 14 }}>
      <div style={card}>
        ...
        <p style={muted}>Ось твій контент. Можеш відредагувати і скопіювати.</p>
      </div>

      <div style={card}>
        <div style={resultBox}>
          {text || "Немає тексту. Повернись у генератор і створіть пост."}
        </div>
        ...
        <button style={ghostBtn} onClick={() => router.push("/generate")}>
          ← Назад
        </button>
...
const info: React.CSSProperties = { marginTop: 10, fontSize: 12, opacity: 0.8 };
